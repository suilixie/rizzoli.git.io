(function($) {
  ...
  Header.prototype = {
    ...
    animate: function() {
      ...
      if (Math.abs(this.lastScrollTop - scrollTop) <= this.delta) { return; } checks if the user has scrolled enough down and past navbar ((scrolltop> this.lastScrollTop) && (scrollTop > this.headerHeight)) {
